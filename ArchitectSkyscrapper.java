...
public class ArchitectSkyscrapper {
	...
	public void implementSkyscraperApp() {
		...
		displayFloorsConstructBySize();
	}
	//get the floor size on the day
...
//to display the Floors that will Constructed By Size -largest below , smallest on top
	private void displayFloorsConstructBySize() {
		System.out.println();
